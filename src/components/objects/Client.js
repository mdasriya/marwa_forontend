...
const loadClients = async () => {
  let query="SELECT * FROM `rwt_handloans_client`;";
    ...
    const onAdd = () =>{
        ...
        if (party_name.length === 0) {
          ...
          }   else {
            {
              ...
              var query = "INSERT INTO `rwt_handloans_client` (`client_id`, `party_name`, `contact_no`, `remarks`, `amount`) VALUES (NULL, '"+party_name+"', '"+contact_no+"', '"+remarks+"', '"+0+"');";
    ...
    const onDelete = async (index) => {
      let query="DELETE FROM `rwt_handloans_client` WHERE client_id = "+index+";";
    ...
    <>
        <div className='tankMainDiv shadow-lg p-3 mb-5 bg-body-tertiary rounded bigFontWeight'>   
            ...
            <h2 className='mt-3 text-center'>Add Advances/Handloan Client</h2>
