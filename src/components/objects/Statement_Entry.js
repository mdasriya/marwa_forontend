    ...
    /*    function loadCheckBoxes(boxesdata){
        ...
        <>
            <div className='tankMainDiv shadow-lg p-3 mb-5 bg-body-tertiary rounded bigFontWeight'>   
                ...
                <h3 id="showbname" className='mt-3 text-center'>- select bank first -</h3>
                    ...
                    <table class="table">
                        <thead>
                            <tr className='table-secondary'>
                                ...
                                <th className='tablebg' style={{width:'200px'}}>{label1}</th>
                        ...
                        <tbody>
                            <tr>    
                                ...
                                <td><input type="date" class="form-control editableInput bigFontWeight" placeholder="Date" onChange={(e) => setDate(e.target.value)} /></td> 
                                <td scope="row">
                                    <select  class="form-select editableInput bigFontWeight" aria-label="Default select example" value={bankName}  onChange={(e) =>{ setBankName(e.target.value); loadSatement(e.target.value); showBank(e.target.value); getTotalAmount1(e.target.value);/*  setSelectedValues(e.target.value); */}}>
                                        <option selected>- select -</option>
                                        
                                        {banks.map((rest) => (  
                                            <option value={rest.bank_account_id}>{rest.name} - {rest.account_no} - {rest.head_name} </option>
                                        ))}
                                    </select>  
                                </td>
                                ...
                                <td style={{display:'flex'}}>
                                        <select  class="form-select editableInput bigFontWeight" aria-label="Default select example" value={selectedmode}  onChange={(e) =>{ setSelectedMode(e.target.value); /*  setSelectedValues(e.target.value); */}}>
                                        <option selected>- select -</option>
                                    ...
                                    <input type="text" class="form-control editableInput bigFontWeight" placeholder="" onChange={(e) => setCheque(e.target.value)} /></td>
                            <td scope="row">
                                    <select  class="form-select editableInput bigFontWeight" aria-label="Default select example" value={type}  onChange={(e) =>{ setType(e.target.value); setLabel1(e.target.value); disabledropop1();/*  setSelectedValues(e.target.value); */}}>
                                        <option id='dropop1' selected >- select -</option>
                ...
                <div>
                    ...
                    <table class="table" >
                        <thead>
                            ...
                            {/*  <th className='tablebg'>Bank-Particualr</th> */}
                                <th className='tablebg'>Mode</th>
                                <th className='tablebg'>Debit<br></br> (outward)</th>
                                <th className='tablebg'>Credit<br></br> (inward)</th>
                                ...
                                {/*       <td> <input style={{width:'20px', height:'20px', border:'1px solid '}} type="checkbox" id={'check'+res.statemnt_id} value='0' class="form-check-input"/> </td>
                                        ...
                                        */}
                                        <td style={{width:'120px'}}>
                                            <button type="button" style={{height:'30px', paddingTop:'2px'}} id={"data"+res.statemnt_id} class="btn btn-danger" onClick={() => onDelete(res.statemnt_id)}>Delete</button> &nbsp;&nbsp; 
                                            </td>
                                    </tr>
                                )}
                        </tbody>
