            ...
            <div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>    
                            <td scope="row">
                                <input type="number" class="form-control editableInput bigFontWeight " placeholder="Tank No." onChange={(e) => setTankNo(e.target.value)} />
                            </td>
                            <td><input type="text" class="form-control editableInput bigFontWeight " placeholder="Product Name" onChange={(e) => setProduct(e.target.value)} /></td>
                            <td><input type="text" class="form-control editableInput bigFontWeight " placeholder="Capacity (Liters)" onChange={(e) => setCapacity(e.target.value)} /></td>
                            <td><input type="text" class="form-control editableInput bigFontWeight " placeholder="Nozzels Count" onChange={(e) => setNozzles(e.target.value)} /></td>
                    ...
                    <tbody>
                        ...
                        {tanks.map((res,index)=>
                                <tr className='hovereffect' key={index}>
                                    ...
                                    <td className='tdbc1'>
                                        <button type="button" id={"tank"+res.tank_no} class="btn btn-success " onClick={() => onSave(res.tank_no)}>Save</button> &nbsp;
                                        ...
                                        <button type="button" id={"tank"+res.tank_no} class="btn btn-danger " onClick={() => onDelete(res.tank_no)}>Delete</button>
                                    </td>
                                </tr>
                            )}
                    </tbody>
