    ...
    <>
        <div className='tankMainDiv shadow-lg p-3 mb-5 bg-body-tertiary rounded bigFontWeight'>   
            ...
            <div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>    
                        <td scope="row">    
                                 <select style={{width:'270px'}} class="form-select editableInput bigFontWeight" aria-label="Default select example" value={icrad}  onChange={(e) =>{ setICard(e.target.value); setICardInfo(e.target.value); /*  getTotalAmount1(e.target.value); *//*  setSelectedValues(e.target.value); */}}>
                                      <option selected>- select -</option>
                                        
                                      {petrocard.map((rest) => (  
                                          <option value={rest.id}>{rest.batch-1} - {rest.machinename} - {  rest.tid1} - {  rest.tid2} - {  rest.tid3} </option>
                                      ))}
                                  </select> 
                           
                            </td>
                            <td scope="row">    
                                <input type="text" id="tid1" class="form-control bigFontWeight" placeholder=""  disabled/>
                            </td>
                            <td scope="row">    
                                <input type="text" id="tid2" class="form-control bigFontWeight" placeholder=""  disabled/>
                            </td>
                            <td scope="row">    
                                <input type="text" id="tid3" class="form-control bigFontWeight" placeholder=""  disabled/>
                            </td>
                            <td scope="row">    
                            <input type="text" id="lastb" class="form-control bigFontWeight" placeholder=""  disabled/>
                           </td>
                           <td scope="row">    
                           <input type="text" id="currentb" class="form-control bigFontWeight" placeholder=""  disabled/>
                            </td>
                            <td scope="row">    
            ...
            <div>
                ...
                <tr className='table-secondary'>               
                    ...
                    {THistory.map((res,index)=>
                                <tr className='hovereffect' key={index}>
                                   <td>{index+1}</td>
                                    <td>{getPCData(res.machine_name)}</td>
                ...
                <div style={{marginLeft:'900px'}}>Total Amount : <span id='petrocard'>0</span></div>
            </div>      
        </div>
    </>
  )
