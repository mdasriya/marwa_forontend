                ...
                <table class="table" >
                    ...
                    {nozzlesms.map((res,index)=>
                                <tr className='bigFontWeight' key={index}>
                                    ...
                                    <td><input type="text" id={"openingms"+(index+1)}  class="form-control bigFontWeight" placeholder="Loading.."   disabled/></td>
                                   ...
                                   <td  ><input type="text" id={"closingms"+(index+1)} class="form-control editableInput bigFontWeight" placeholder="" onChange={(e)=> {calculateSale(e.target.value,(index+1),"ms"); calcTotalMs((index+1));}}     /></td>
                                   <td ><input type="text" id={"salems"+(index+1)} class="form-control bigFontWeight" placeholder="" onChange={(e)=> {setNarration(e.target.value)}}     disabled /></td>
                                   <td  ><input type="text" id={"testingms"+(index+1)} class="form-control editableInput bigFontWeight" placeholder="" onChange={(e)=> {calculateASale(e.target.value,(index+1),"ms"); calcTotalMs(index+1);}}     /></td>
                                   <td > <input type="text" id={"asalems"+(index+1)} class="form-control bigFontWeight" placeholder="" onChange={(e)=> {setNarration(e.target.value)}}    disabled /></td>
                                   <td ><input type="text" id="ratems"  className="form-control bigFontWeight ratems" placeholder=""    disabled /></td>
                                   <td ><input type="text" id={"amountms"+(index+1)} class="form-control bigFontWeight" placeholder="" onChange={(e)=> {setNarration(e.target.value)}}    disabled /></td>
                            ...
                            <tr>
                                ...
                                <th className='tablebg'><span id="ratetotalms">{/* {dayStartRate[0]['ms']} */}</span> (=)</th>
                                <th className='tablebg'><span id="amounttotalms">0.00</span></th>
                        </tr>
                    </tbody>
                </table>        
                                
                <button type="button" style={{height:'35px', width:'90px' , fontSize:'20px', paddingTop:'1px',marginTop:'12px', marginLeft:'90%', backgroundColor:'green'}} /* id={"data"+res.staff_id} */ class="btn btn-primary" id='button1' onClick={() =>{  onSaveMsUpdate(); markSaved('button1')}}>Save</button>
                    ...
                    {nozzlesspeed.map((res,index)=>
                                <tr  key={index} style={{fontWeight:'700'}}>
                                   ...
                                   <td id={"nozzlesspeed"+(index+1)}>{res.nozzle_name}</td>
                                    <td><input type="text" className='bigFontWeight form-control'  id={"openingspeed"+(index+1)}   placeholder="Loading.."   disabled/></td>
                                                             
                                   <td  ><input class="form-control editableInput bigFontWeight"  type="text" id={"closingspeed"+(index+1)}  placeholder="" onChange={(e)=> {calculateSale(e.target.value,(index+1),"speed"); calcTotalspeed((index+1));}}     /></td>
                                   <td ><input type="text" class="form-control bigFontWeight"  id={"salespeed"+(index+1)}  placeholder="" onChange={(e)=> {setNarration(e.target.value)}}     disabled /></td>
                                   <td  ><input class="form-control editableInput bigFontWeight"  type="text" id={"testingspeed"+(index+1)}  placeholder="" onChange={(e)=> {calculateASale(e.target.value,(index+1),"speed"); calcTotalspeed((index+1));}}     /></td>
                                   <td><input class="form-control bigFontWeight" type="text" id={"asalespeed"+(index+1)}  placeholder="" onChange={(e)=> {setNarration(e.target.value)}}    disabled /></td>
                                   <td><input class="form-control bigFontWeight ratespeed" type="text" id="ratespeed"   placeholder=""    disabled /></td>
                                   <td><input class="form-control bigFontWeight" type="text" id={"amountspeed"+(index+1)}  placeholder="" onChange={(e)=> {setNarration(e.target.value)}}    disabled /></td>
                            ...
                            <tr>
                                ...
                                <th className='tablebg'> </th>
                                <th className='tablebg'>Total (=)</th>
                                <th className='tablebg'><span id="saletotalspeed">0</span> (-)</th>
                                <th className='tablebg'><span id="testingtotalspeed">0</span > (=)</th>
                                <th className='tablebg'><span id="asaletotalspeed">0</span> (x)</th>
                                <th className='tablebg'><span id="ratetotalspeed">{/* {dayStartRate[0]['speed']} */}</span> (=)</th>
                                <th className='tablebg'><span id="amounttotalspeed">0.00</span></th>
                        </tr>
                    </tbody>
                </table>        
                                
               <button type="button" style={{height:'35px', width:'90px' , fontSize:'20px', paddingTop:'1px',marginTop:'12px', marginLeft:'90%', backgroundColor:'green'}} /* id={"data"+res.staff_id} */ class="btn btn-primary" id='button2' onClick={() =>{  onSavespeedUpdate(); markSaved('button2')}}>Save</button>
                ...
                <table class="table" >
                    ...
                    {nozzleshsd.map((res,index)=>
                                <tr  key={index}>
                                    ...
                                    <td className='bigFontWeight'  id={"nozzleshsd"+(index+1)}>{res.nozzle_name}</td>
                                    <td><input class="form-control bigFontWeight" type="text" id={"openinghsd"+(index+1)}  placeholder="Loading.."   disabled/></td>
                                                                {/*  <td><input type="text" id={"amt"+res.staff_id}  placeholder="Amount"  onChange={(e) => {
                                        const updatedAmounts = { ...amounts };
                                        updatedAmounts[res.staff_id] = parseFloat(e.target.value) || 0;
                                        setAmounts(updatedAmounts);
                                    }}   style={{width:'250px'}}    /></td> */}
                                   <td  ><input class="form-control editableInput bigFontWeight" type="text" id={"closinghsd"+(index+1)}  placeholder="" onChange={(e)=> {calculateSale(e.target.value,(index+1),"hsd"); calculateASale(e.target.value,(index+1),"hsd"); calcTotalhsd((index+1));}}     /></td>
                                   <td ><input class="form-control bigFontWeight" type="text"  id={"salehsd"+(index+1)}  placeholder="" onChange={(e)=> {setNarration(e.target.value)}}     disabled /></td>
                                   <td  ><input class="form-control editableInput bigFontWeight" type="text" id={"testinghsd"+(index+1)}  placeholder="" onChange={(e)=> {calculateASale(e.target.value,(index+1),"hsd"); calcTotalhsd((index+1));}}     /></td>
                                   <td><input class="form-control bigFontWeight" type="text" id={"asalehsd"+(index+1)}  placeholder="" onChange={(e)=> {setNarration(e.target.value)}}    disabled /></td>
                                   <td><input class="form-control bigFontWeight" type="text" id="ratehsd"  className="form-control ratehsd" placeholder=""    disabled /></td>
                                   <td><input class="form-control bigFontWeight" type="text" id={"amounthsd"+(index+1)}  placeholder="" onChange={(e)=> {setNarration(e.target.value)}}    disabled /></td>
                            ...
                            <tr>
                                ...
                                <th className='tablebg'> </th>
                                <th className='tablebg'>Total (=)</th>
                                <th className='tablebg'><span id="saletotalhsd">0</span> (-)</th>
                                <th className='tablebg'><span id="testingtotalhsd">0</span > (=)</th>
                                <th className='tablebg'><span id="asaletotalhsd">0</span> (x)</th>
                                <th className='tablebg'><span id="ratetotalhsd">{/* {dayStartRate[0]['hsd']} */}</span> (=)</th>
                                <th className='tablebg'><span id="amounttotalhsd">0.00</span></th>
                            </tr>
                    </tbody>
                </table>        
                                
                <button type="button" style={{height:'35px', width:'90px' , fontSize:'20px', paddingTop:'1px',marginTop:'12px', marginLeft:'90%', backgroundColor:'green'}} /* id={"data"+res.staff_id} */ class="btn btn-primary" onClick={() =>{  onSavehsdUpdate();}}>Save</button>
