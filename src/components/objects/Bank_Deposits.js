                    ...
                    <thead>
                        <tr className='table-secondary'>
                          {/*   <th className='tablebg'>Date</th> */}
                            <th className='tablebg'  style={{width:'350px'}} >Bank-Particualr</th>
                         
                           
                            <th className='tablebg'  style={{width:'200px'}} >Amount</th>
                    ...
                    <tbody>
                        <tr>    
                           ...
                           {/*  <td><input type="date" class="form-control bigFontWeight" placeholder="Date" onChange={(e) => setDate(e.target.value)} /></td> */}
                            ...
                            <td><input type="text" style={{width:'200px'}} class="form-control editableInput bigFontWeight" placeholder="Amount" onChange={(e) =>{ setAmount(e.target.value); numberToWords(e.target.value);} }/></td>
                            <td><input type="text"  class="form-control bigFontWeight" value={amountInWord} placeholder="" disabled /></td>
                              ...
                              {/*       <td> <input style={{width:'20px', height:'20px', border:'1px solid '}} type="checkbox" id={'check'+res.statemnt_id} value='0' class="form-check-input"/> </td>
                                    ...
                                    */}
                                    <td style={{width:'120px'}}>
                                        <button type="button" style={{height:'30px', paddingTop:'2px'}} id={"data"+res.statemnt_id} class="btn btn-primary" onClick={() => onDelete(res.statemnt_id)}>Delete</button> &nbsp;&nbsp; 
                                           </td>
                                </tr>
                            )}
