...
export default function Oil_Purchase({dbpath1}) {
    ...
    const loadOilProducts = async () => {
      ...
      const loadOilPurchases = async () => {
        let query="SELECT * FROM `rwt_oil_purchase` WHERE move_status = '"+0+"' AND date ='"+datecache+"';";
        /*  
            alert(query); */
            ...
            try {
                ...
                if (response && response.data) {
                    ...
                    if (response.data.phpresult) {
                        setOil_Purchase_Not_Settled(response.data.phpresult); 
      ...
      const setProductSelectValues = (index) =>  {
        const selectedProduct = oilproduct.find(product => product.product_id === index);
    ...
    <>
        ...
        <span style={{fontSize:'22px'}}> Date : {convertDateFormat(datecache)}</span> <br></br>
           ...
           <div>
            <div></div> 
                    ...
                    <tbody>
                       ...
                       {/*  <td>
                            ...
                            <td scope="row">
                             ...
                             <td scope="row" >
                                <input type="text" class="form-control editableInput bigFontWeight" placeholder="Invoice No." value={invoiceNo}  onChange={(e) => setInvoiceNo(e.target.value)} />
                            </td>
                            {/* <td><input type="date" value={datecache} class="form-control bigFontWeight"  onChange={(e) => setDate(e.target.value)} /></td>
                             */}
                            <td scope="row" >
                                <input type="text" class="form-control editableInput bigFontWeight" placeholder="Total Amount" value={InvoiceTAmount} onChange={(e) => {setTempInvoiceTAmount(e.target.value); setInvoiceTAmount(e.target.value)}} />
                            </td>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <td >
                                ...
                                <input type="text"  class="form-control editableInput bigFontWeight" placeholder="Sr no." onChange={(e) => setSr(e.target.value)} /> 

                            </td>
                            <td scope="row" >
                                
                                <div className="input-group mb-3">
                                <select className="form-select editableInput bigFontWeight" id="inputGroupSelect01" value={product}onChange={e => {
                                ...
                                >
                                    ...
                                    {oilproduct.map((rest) => (
                                    <option value={rest.product_id}>{rest.product_name} {rest.product_grade } {rest.product_volume_per_pcs}</option>
                                    ))}
                                </select>
                                </div> </td>
                            <td scope="row">
                                <input type="text"  class="form-control bigFontWeight" id="idgrade" value={grdae} placeholder="Grade" onChange={(e) => setGrdae(e.target.value)} disabled/>
                            </td>
                            <td><input type="text" class="form-control bigFontWeight" id="idcolor" value={color}  placeholder="Color" onChange={(e) => setColor(e.target.value)} disabled/></td>
                            <td ><input type="text"  class="form-control bigFontWeight editableInput" id="idmrp" value={mrp} placeholder="MRP" onChange={(e) => setMrp(e.target.value)} /></td>
                            <td>
                                <input type="text" class="form-control bigFontWeight" id="idvolume" value={volume} placeholder="Volume" onChange={(e) => setPVolume(e.target.value)} disabled /> 
                             </td>
                            <td><input type="text" class="form-control bigFontWeight" id='idpcs' value={pcs} placeholder="Pcs" onChange={(e) => setPcs(e.target.value)} disabled/></td>
                            <td ><input type="text" class="form-control editableInput bigFontWeight" id='idtcases'  placeholder="Purchase t cases" onChange={(e) =>{ setTcases(e.target.value); totalLiters(e.target.value); }} /></td>
                            <td scope="row">
                                <input type="text" class="form-control bigFontWeight" id="idtpcs" value={tpcs}  placeholder="Total PCS" onChange={(e) => setTpcs(e.target.value)} disabled />
                            </td>
                            {/* <td scope="row">
                    ...
                    <tbody>
                        <tr>    
                            ...
                            <td>
                                ...
                                <input type="text" class="form-control bigFontWeight" value={volume} placeholder="Volume" onChange={(e) => setPVolume(e.target.value)} disabled /> 

                            </td>
                            <td scope="row">
                                <input type="text" class="form-control bigFontWeight" value={tpcs} placeholder="Total PCS" onChange={(e) => setTpcs(e.target.value)} disabled />
                            </td>
                            <td scope="row"> 
                                <input type="number" class="form-control bigFontWeight" value={tltrs} placeholder="Total Ltrs" onChange={(e) => {setTltrs(e.target.value);}} disabled />
                            </td>
                            <td ><input type="text" class="form-control editableInput bigFontWeight" placeholder="Rate" onChange={(e) => {setRatePerUnit(e.target.value); calcTaxablevalue(e.target.value);}} /></td>
                        <td scope="row">
                                <input type="text" class="form-control bigFontWeight"  value={taxableValue} placeholder="Taxable Value" onChange={(e) => setTaxableValue(e.target.value)} disabled/>
                            </td>
                        </tr>
                ...
                <table class="table">
                    ...
                    <th className='tablebg'>Taxable Value</th>
                        ...
                        <th className='tablebg' style={{width:'100px'}}>CGST (+)</th>
                        <th className='tablebg' style={{width:'100px'}}>SGST (+)</th>
                    ...
                    <tbody>
                        ...
                        <td scope="row">
                        <input type="text" value={taxableValue} class="form-control bigFontWeight" placeholder="Taxable Value" onChange={(e) => setTaxableValue(e.target.value)} disabled />
                            </td>
                            <td scope="row" >
                                <input  type="text" class="form-control editableInput bigFontWeight" placeholder="Discount" onChange={(e) => {setDiscount(e.target.value); calcBalance(e.target.value)}} />
                            </td>
                            <td scope="row">
                                <input type="text" value={balance} class="form-control bigFontWeight" placeholder="Balance" onChange={(e) => setBalance(e.target.value)} disabled />
                            </td>
                            <td scope="row" >
                            <select  class="form-select editableInput bigFontWeight" aria-label="Default select example" value={gst}  onChange={(e) => {setGst(e.target.value); calcGST(e.target.value); }}>
                            ...
                            <td > <select class="form-select bigFontWeight editableInput" aria-label="Default select example" value={gst}  onChange={(e) => {setGst(e.target.value); calcGST(e.target.value);}}>
                                    <option selected>- select -</option>
                            ...
                            <td ><input type="text" class="form-control editableInput bigFontWeight" placeholder="TCS" onChange={(e) => {setTCS(e.target.value); calcTotalAmount(e.target.value);}} /></td>
                            <td><input type="text" class="form-control bigFontWeight" value={tamount} placeholder="Total Amount" onChange={(e) => setTamount(e.target.value)} disabled/></td>
                            <td scope="row">
                                <input type="text" class="form-control bigFontWeight" value={tpcs} placeholder="Total PCS" onChange={(e) => setTpcs(e.target.value)} disabled />
                            </td>
                            <td><input type="text" class="form-control bigFontWeight" value={lPrice} placeholder="Landing Price" onChange={(e) => setlPrice(e.target.value)} disabled /></td>
                            {/* <td><input type="text" class="form-control bigFontWeight" placeholder="difference" onChange={(e) => setDiffernce(e.target.value)} /></td>
                             */}
                        </tr>
                    </tbody>
                </table>   
                <span  style={{marginLeft:'450px', color:'green'}}>{cgst}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{cgst}</span> 
                ...
                <table class="table" style={{width:'900px'}}>
                    ...
                    <tbody>
                        <tr>    
                        <td scope="row">
                                <input type="text" value={productName} class="form-control bigFontWeight" placeholder="Prodduct Name" onChange={(e) => setProductName(e.target.value)} disabled/>
                            </td>
                            <td>
                                <input type="text" value={volume} class="form-control bigFontWeight" placeholder="Volume" onChange={(e) => setPVolume(e.target.value)} disabled /> 
                            </td>
                            <td><input type="text" value={mrp} class="form-control bigFontWeight" placeholder="MRP" onChange={(e) => setMrp(e.target.value)} disabled/></td>
                            <td><input type="text" value={lPrice} class="form-control bigFontWeight" placeholder="Landing Price" onChange={(e) => setlPrice(e.target.value)} disabled /></td>
                            <td><input type="text" style={{color:'red'}} value={Differnce} class="form-control bigFontWeight" placeholder="difference" onChange={(e) => setDiffernce(e.target.value)}  disabled/> </td>
                             {/* <td><input type="text" class="form-control bigFontWeight" placeholder="Rate" onChange={(e) => setRatePerUnit(e.target.value)} /></td> */}
            ...
            <table class="table" style={{width:'900px'}}>
                ...
                <center><button type="button" class="btn btn-primary" onClick={()=> { onAdd(); timeoutFunc(); }}>Add</button></center>
            </div>
            <br></br>
            <div>
                <br></br>
            <h2 className='mt-3 text-center'>Invoice Purchases</h2>
                         ...
                         {tHistory.map((res,index)=>
                                <tr className='hovereffect' key={index}>
                                    ...
                                    <td /* style={{width:'250px'}} */>
                                        ...
                                        <button type="button" id={"tank"+res.purchase_id} class="btn btn-danger" onClick={() => {onDelete(res.purchase_id);  timeoutFunc(); }}>Delete</button>
                                    </td>
                                </tr>
                            )}
                ...
                <center><button type="button" class="btn btn-warning"  onClick={onMoveToGodown} >Move to Godown</button></center>
            </div>      
        </div>
    </>
  )
