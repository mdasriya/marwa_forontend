            ...
            <div>
                ...
                <table class="table" style={{width:'1000px'}}>
                    ...
                    <tbody>
                        <tr>    
                            <td scope="row">
                                <input type="text" class="form-control bigFontWeight editableInput" placeholder="Bill No" onChange={(e) => setBillNo(e.target.value)} />
                            </td>
                            <td>
                            <select class="form-select bigFontWeight editableInput" aria-label="Default  select example" value={customerName}   onChange={(e) =>{ setCustomerName(e.target.value); } }>
                            ...
                            <td><input type="month" class="form-control editableInput bigFontWeight" placeholder="date" onChange={(e) => setDate(e.target.value)} /></td>
                            <td><input type="date" class="form-control editableInput bigFontWeight" placeholder="date" onChange={(e) => setDateinBill(e.target.value)} /></td>
                          
                           
                                 <td><button type="button" class="btn btn-primary"  onClick={(e) =>{onAdd(); getTaotalAmt(e.target.value);}}>Generate Bill</button></td>
                        </tr>
                ...
                <div id='printableDiv'  ref={componentRef}  style={{width:'1000px', border:'1px solid black'}}>
                <div style={{width:'1000px', height:'200px'}}>
<br></br>
                <div style={{display:'flex'}}>
                    <img style={{width:'70px', height:'50px', marginLeft:'30px'}} src={wlogo}></img>
                    <h2 style={{marginLeft:'200px'}}><u>M/s. MARWAH & COMPAMNY</u></h2>
                </div> 
                <h5  style={{marginLeft:'270px'}}>Opp. Law College Sq., Amravati Road, Nagpur-440 010</h5>
                <h5  style={{marginLeft:'282px'}}>DEALERS BHARAT PETROLEUM CORPORATION LTD.</h5><br></br>

                <div style={{display:'flex'}}>
                    <h6  style={{marginLeft:'150px'}}>VAT TIN No.: 2749063602V wef 03.04.2010</h6>
                    <h6  style={{marginLeft:'150px'}}>Mob.: 9096069674/9764027164</h6>
                </div>
                <br></br> 
              ...
              <td><span style={{marginLeft:"150px"}}> Customer Nmae : {customerName}</span></td> <td> <span style={{marginLeft:"300px"}}>Date : </span></td></table></h5>
                ...
                <br></br><br></br>
                        ...
                        <tr >
                            ...
                            <th style={{border:'1px solid black', width:'130px'}} >Slip No.</th>
                            <th style={{border:'1px solid black', width:'120px'}} >Vehicle No.</th>
                            <th style={{border:'1px solid black', width:'120px'}} >Product</th>
                            <th style={{border:'1px solid black', width:'120px'}} >Rate</th>
                            <th style={{border:'1px solid black', width:'130px'}} >LTS</th>
                            <th style={{border:'1px solid black', width:'120px'}} >Amount</th>
                        ...
                        {fetchedData.map((res,index)=>
                             ...
                             <tr className=''>
                                        ...
                                        <td id="totalAmt" style={{border:'1px solid black'}}>--</td>
                ...
                <br></br><br></br>
                <div style={{width:'800px', height:'200px', marginLeft:'100px'}}>
                    
                    <table style={{ width:'800px'}}>
                        <tr style={{border:"1px solid black", padding:'8px',  width:'800px'}} >
                            <td><center><b>Payment Details</b> </center></td>
                        </tr>
                        <tr  style={{border:"1px solid black", padding:'20px', width:'800px'}} >
                            <td style={{display:'flex', gap:'10px'}}><h6 style={{width:'150px'}}>Bank Name : </h6>
                        ...
                        <tr  style={{border:"1px solid black", padding:'20px', width:'800px'}} >
                            <td style={{display:'flex', gap:'10px'}}><h6 style={{width:'150px'}}>Payment Mode : </h6> {/* <select style={{width:'200px'}}  class="form-select" aria-label="Default select example" value={type}  onChange={(e) =>{ setType(e.target.value);}}>
                                    <option selected>- select -</option>
                                ...
                                <td style={{}}><h6 style={{width:'180px'}}></h6>{/*  <input type="text" class="form-control bigFontWeight" placeholder="" onChange={(e) => setCheqNo(e.target.value)} /> */}</td>
                       
                         </td>
                        </tr>
                        <tr  style={{border:"1px solid black", padding:'20px', width:'800px'}} >
                            <td style={{display:'flex', gap:'10px'}}><h6 style={{width:'180px'}}>Payment Amount : </h6> {/* <input type="text" class="form-control bigFontWeight" placeholder="Payment Amount" onChange={(e) => setAmount(e.target.value)} />*/}</td>
                        </tr>
                        <tr  style={{border:"1px solid black", padding:'20px', width:'800px'}} >
                            <td style={{display:'flex', gap:'10px'}}><h6 style={{width:'150px'}}>Dated : </h6> {/* <input type="date" style={{width:'200px'}} class="form-control bigFontWeight" placeholder="Payment Amount" onChange={(e) => setCheqDate(e.target.value)} /> */}</td>
                        </tr>
                        <tr  style={{border:"1px solid black", padding:'20px', width:'800px'}} >
                            <td style={{display:'flex', gap:'10px'}}><h6 style={{width:'180px'}}>Remark : </h6> {/* <input type="text" class="form-control bigFontWeight" placeholder="Remark" onChange={(e) => setRemark(e.target.value)} /> */}</td>
                        </tr>
                    </table>
                </div>
                <br></br><br></br>
            ...
            <center> <PrintButton targetRef={componentRef} /> &nbsp; <button type="button" class="btn btn-success"  onClick={(e) =>{/* onPayBill() */  setInvoiceNo();  setGeneratedBill();}}>Save</button></center>
