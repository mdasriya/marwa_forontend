                    ...
                    <tbody>
                        ...
                        <td scope="row">    
                            ...
                            <td><input type="text" class="form-control editableInput bigFontWeight" placeholder="MRP" onChange={(e) => setMrp(e.target.value)} /></td>
                             ...
                             <input type="text" class="form-control editableInput bigFontWeight" style={{width:'150px'}} placeholder="Volume" onChange={(e) => setPVolume1(e.target.value)} />
                            <select class="form-select editableInput bigFontWeight" style={{width:'100px'}} aria-label="Default select example" value={volume} onChange={(e) => setPVolume2(e.target.value)} /* value={machine}  onChange={(e) => setMachine(e.target.value)}*/>
                    ...
                    <tbody>
                        ...
                        {oilproduct.map((res)=> 
                                <tr className='hovereffect'>
                                    ...
                                    <td>{/* {res.product_mrp} */}<input type="text" class="form-control editableInput bigFontWeight" placeholder="loading.." id={'mrp'+res.id} style={{width:'180px'}}/></td>
                                    <td>{res.size}</td>
                                    <td>{/* {res.product_pcs_per_caserwt_oil_products} */}<input type="text" class="form-control editableInput bigFontWeight" placeholder="loading.." id={'pcs'+res.id} style={{width:'180px'}}/></td>
                                    <td style={{width:'250px'}}>
                                      ...
                                      <button type="button" id={"tank"+res.tank_no} class="btn btn-primary">Open</button> &nbsp; */}
                                          <button type="button" id={"tank"+res.id} class="btn btn-success " onClick={() => onSave(res.id)}>Save</button> &nbsp;&nbsp;
