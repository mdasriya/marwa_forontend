...
<Route path="/OilReports1" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/OilReports2" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/OilReports3" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/ExpensesReport" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/ExpensesReport1" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/ExpensesReport2" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/ExpensesReport3" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/AdvancesHandloanReport" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
        ...
        <Route path="/AdvancesHandloanReport1" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/AdvancesHandloanReport2" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/AdvancesHandloanReport3" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/BankStatements" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/BankStatements1" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/BankStatements2" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/BankStatements3" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/CardsReport" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/CardsReport1" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/CardsReport2" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/CardsReport3" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/creditreport1" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/creditreport2" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/creditreport3" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/creditreport4" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
  ...
  <Route path="/CreditClientReport" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/PetrolReport1" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
      ...
      <Route path="/PetrolReport2" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/PetrolReport3" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/PetrolReport4" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/PetrolReport5" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/PetrolReport6" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
      ...
      <Route path="/PetrolReport" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div >
                  ...
                  <Navbar />
                  <PetrolReport dbpath1={dbpath1} dateDayStart={dateDayStart} setDate1={setDate1} setDate2={setDate2} setDate3={setDate3} setDate4={setDate4} setDate5={setDate5} setDate6={setDate6} setDate7={setDate7} setDate8={setDate8} />
                </div>
            </div>
          </>
        } />  

<Route path="/Day_End" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/pouches_godown" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <pouches_godown dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

<Route path="/pouches_purchase" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <pouches_purchase dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

<Route path="/Petro_Card" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Wallet_Payment" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Wallet_Payment dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

<Route path="/Add_Wallet" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Add_Petro_Card" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Add_Petro_Card dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

<Route path="/Staff_Salary" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Statement_Entry" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Statement_Entry dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

<Route path="/Bank_Deposits" element={
          <> 
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Bank_Deposits dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />
          ...
          <>
            <div style={{display:'flex'}}>
              <div >
                ...
                <div>
                  <Navbar /> 
                  <Day_Start dbpath1={dbpath1} dateDayStart={dateDayStart} setDate={setDate}/>
               </div>
            </div> 
          </>
        } />

<Route path="/Bank_Statement" element={
          <>
            <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar /> 
                  <Bank_Statement dbpath1={dbpath1} dateDayStart={dateDayStart}/>
               </div>
            </div> 
          </>
        } />
...
<Route path="/add_staff" element={
      ...
      <Route path="/Client_Cheque" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Client_Cheque dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />
...
<Route path="/Oil_Pouches" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/add_payments_mode" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Fuel_Sales" element={
        ...
        <Route path="/Oil_Purchase" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Generate_Bills" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Generate_Bills dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

<Route path="/Add_Bank" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Petrol_Decantation" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Petrol_Decantation dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

<Route path="/Petrol_Invoice_Feeding" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Petrol_Invoice_Feeding dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />
      ...
      <Route path="/add_client2" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/credit_client" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Credit_Client dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />

        <Route path="/handloans" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Daily_Expenses" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Oil_Products" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
...
<Route path="/Petrol_Products" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Petrol_Products dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />
...
<Route path="/Add_Oil_Pouches" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Add_Oil_Pouches dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />
<Route path="/Add_Expenses_Topic" element={
          <>
           <div style={{display:'flex'}}>
              <div >
                  <Sidebar />
                ...
                <div>
                  <Navbar />
                  <Add_Expenses_Topic dbpath1={dbpath1} dateDayStart={dateDayStart} />
                </div>
            </div>
          </>
        } />
